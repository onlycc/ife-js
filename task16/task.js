...
function addAqiData() {
    var city = doc.getElementById('aqi-city-input').value.trim();
    var aqi = doc.getElementById('aqi-value-input').value.trim();
...
function renderAqiList() {
    var table = doc.getElementById('aqi-table');
...
function init() {
    ...
    doc.getElementById("add-btn").onclick = function(){
        addBtnHandle();
    };
